...
import { ApiError, apiRequest as api } from "@/lib/api";
import { GovernanceFeedback } from "@/features/mvp1/components/governance-control-ui";
import { normalizeGovernanceError, type GovernanceUiError } from "@/features/mvp1/lib/governance-errors";
import {
  type ReleaseRequest,
...
} from "@/features/mvp1/lib/release-governance";
import {
  type AgentRecord,
  ...
  type AgentDraftForm,
} from "@/features/mvp1/lib/agent-registry";
import {
  type AuditEvent,
  type Budget,
  ...
  type Usage,
  type Workspace,
} from "@/features/mvp1/lib/governance";
import {
  mapRuntimeStatus,
  killAgent,
  clearKillSwitch,
  ...
  retireAgent,
  approvePermission,
} from "@/features/mvp1/lib/governance-actions";
import { SourcesView } from "@/features/mvp1/components/governance/sources-view";
import { ReadinessDecisionsPanel } from "@/features/mvp1/components/governance/readiness-decisions-panel";
import {
...
} from "@/features/mvp1/lib/governance-data";
...
export function GovernanceDashboard() {
  ...
  function changeView(nextView: NavView) {
    setView(nextView);
    window.history.replaceState(null, "", `/genesis?view=${nextView}`);
  }
            ...
            <div className="gov-subnav">
              <button
                ...
                onClick={() => {
                  ...
                  window.history.replaceState(null, "", `/genesis?view=agents&sub=agents`);
                }}
                type="button"
              >
              ...
              <button
                ...
                onClick={() => {
                  ...
                  window.history.replaceState(null, "", `/genesis?view=agents&sub=releases`);
                }}
                type="button"
              >
                <span className="gov-subnav-dot" />
              ...
              <button
                ...
                onClick={() => {
                  ...
                  window.history.replaceState(null, "", `/genesis?view=agents&sub=tests`);
                }}
                type="button"
              >
                <span className="gov-subnav-dot" />
              ...
              <button
                ...
                onClick={() => {
                  ...
                  window.history.replaceState(null, "", `/genesis?view=agents&sub=reviews`);
                }}
                type="button"
              >
                <span className="gov-subnav-dot" />
              ...
              <section className="gov-mid-grid">
                ...
                <article className="gov-panel">
                  <div className="gov-panel-header">
                    ...
                    <Link className="gov-panel-link" href="/genesis?view=audit">
                      Lihat Semua →
                    </Link>
                  </div>
              ...
              <section className="gov-bottom-grid">
                ...
                <article className="gov-panel">
                  <div className="gov-panel-header">
                    ...
                    <Link className="gov-panel-link" href="/genesis?view=agents&sub=reviews">
                      Lihat Semua →
                    </Link>
                  </div>
                  <div className="gov-table-wrap">
                ...
                <article className="gov-panel">
                  <div className="gov-panel-header">
                    ...
                    <Link className="gov-panel-link" href="/genesis?view=runtime">
                      Lihat Detail →
                    </Link>
                  </div>
