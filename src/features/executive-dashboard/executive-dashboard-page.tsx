...
export function ExecutiveDashboardPage({ initialSnapshot }: { readonly initialSnapshot?: ExecutiveDashboardSnapshot | null }) {
  return (
    <ProtectedDomainWorkspace deniedDescription="Halaman ini merupakan Executive Command Center dan memerlukan role serta workspace yang diberikan Backend." divisionCodes={["EXEC", "EXECUTIVE"]} loadingLabel="Memuat Executive Command Center…" workspaceKeys={["executive", "director"]}>
